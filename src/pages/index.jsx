      ...
      <div className={styles.light_half}>
        <div className={styles.light_content}>
          ...
          <p>
            ...
            entering the world of technology my background was in Human
            Resources and project management.
          </p>
          <p>
            I'm passionate about growing and supporting the tech community. I've
            been apart of creating Female Coders Lab (both in{' '}
            <a href="https://www.meetup.com/Female-Coders-Lab-Melbourne/">
              Melbourne
            </a>{' '}
            and{' '}
            <a href="https://www.meetup.com/Female-Coders-Lab-Munchen/">
              Munich
            </a>
            ), as well as the Junior Dev Social{' '}
